...
Lung -> log vs. original scale
York regression
Orsini multi-level

# All Sites

  * Don't show sensitivity analyses that do not apply, e.g., brain: lm vs. gls (only studies with ERR/Gy anyway)
  ...
  * Investigate bias when estimating ERR/Gy from dose-category-specific RRs due to uncertainty in category representative (mean) dose? (suggestion David P)
      ...
      * For studies with known per-category mean dose, compare to results from choosing boundary mid-points
