            ...
            tabBox(id="tabbox_data",
                ...
                tabPanel(title="Options for transforming meshes",
                         tagList(uiOutput("ui_import_fix_note"),
                                 ...
                                 uiOutput("ui_reconstruct"),
                                 bs4Card(title=NULL,
                                         id="read_reconstruct_card",
                                         background="gray",
                                         collapsible=FALSE,
                                         tagList(uiOutput("ui_reconstruct_afs_jetsm_bool"),
                                                 ...
                                                 uiOutput("ui_reconstruct_alwrap_opts"))),
                                 uiOutput("ui_smooth"),
                                 bs4Card(title=NULL,
                                         id="read_smooth_card",
                                         background="gray",
                                         collapsible=FALSE,
                                         tagList(uiOutput("ui_smooth_cgal_opts"),
                                                 uiOutput("ui_smooth_vcg_opts"),
                                                 uiOutput("ui_smooth_vcg_taubin_opts"),
                                                 uiOutput("ui_smooth_vcg_fujilaplace_opts"))),
                                 uiOutput("ui_remesh"),
                                 bs4Card(title=NULL,
                                         id="read_remesh_card",
                                         background="gray",
