...
excel_sheets <- list(Haem_Lymph="Tab_5_B_2_Haem_Lymph_meta",
...
overlappingL <- list(Haem_Lymph=c(),
                     Sarcoma   =c(),
...
```{r}
d_RR_all     <- d_RR_allL$Haem_Lymph
d_RR_sel     <- d_RR_selL$Haem_Lymph
d_ERR_all_lw <- d_ERR_allL$Haem_Lymph
d_ERR_sel_lw <- d_ERR_selL$Haem_Lymph
...
```{r}
d_RR_all     <- d_RR_allL$Sarcoma
d_RR_sel     <- d_RR_selL$Sarcoma
d_ERR_all_lw <- d_ERR_allL$Sarcoma
d_ERR_sel_lw <- d_ERR_selL$Sarcoma
d_ERR_long   <- d_ERR_sel_lw$d_ERR_long
d_ERR_wide   <- d_ERR_sel_lw$d_ERR_wide
```
...
```{r}
d_RR_all     <- d_RR_allL$Breast
d_RR_sel     <- d_RR_selL$Breast
d_ERR_all_lw <- d_ERR_allL$Breast
d_ERR_sel_lw <- d_ERR_selL$Breast
d_ERR_long   <- d_ERR_sel_lw$d_ERR_long
d_ERR_wide   <- d_ERR_sel_lw$d_ERR_wide
```
...
```{r}
d_RR_all     <- d_RR_allL$Lung
d_RR_sel     <- d_RR_selL$Lung
d_ERR_all_lw <- d_ERR_allL$Lung
d_ERR_sel_lw <- d_ERR_selL$Lung
d_ERR_long   <- d_ERR_sel_lw$d_ERR_long
d_ERR_wide   <- d_ERR_sel_lw$d_ERR_wide
```
...
```{r}
d_RR_all     <- d_RR_allL$Gastro
d_RR_sel     <- d_RR_selL$Gastro
d_ERR_all_lw <- d_ERR_allL$Gastro
d_ERR_sel_lw <- d_ERR_selL$Gastro
d_ERR_long   <- d_ERR_sel_lw$d_ERR_long
d_ERR_wide   <- d_ERR_sel_lw$d_ERR_wide
```
...
```{r}
d_RR_all     <- d_RR_allL$Thyroid
d_RR_sel     <- d_RR_selL$Thyroid
d_ERR_all_lw <- d_ERR_allL$Thyroid
d_ERR_sel_lw <- d_ERR_selL$Thyroid
d_ERR_long   <- d_ERR_sel_lw$d_ERR_long
d_ERR_wide   <- d_ERR_sel_lw$d_ERR_wide
```
...
```{r}
d_RR_all     <- d_RR_allL$Brain
d_RR_sel     <- d_RR_selL$Brain
d_ERR_all_lw <- d_ERR_allL$Brain
d_ERR_sel_lw <- d_ERR_selL$Brain
d_ERR_long   <- d_ERR_sel_lw$d_ERR_long
d_ERR_wide   <- d_ERR_sel_lw$d_ERR_wide
```
