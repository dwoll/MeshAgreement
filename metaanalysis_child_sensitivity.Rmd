...
# d_ERR_from_RRs <- get_single_ERR_from_RRs(d_RR_uniqueL[[cancer_site]],
#                                           cor_intra=0.5,
#                                           CI_width=0.95)
```
...
```{r eval=FALSE}
## pool estimates
# d_ERR_org <- d_ERR_uniqueL[[cancer_site]]$d_ERR_wide %>%
...
```{r eval=FALSE}
# child='metaanalysis_child_meta.Rmd'
```
...
d_ERR_out <- d_ERR_wide_ma %>%
    ...
    select(site, auth_year, ERR, ERR_CIlo, ERR_CIup, ERR_SE, weight, used)
